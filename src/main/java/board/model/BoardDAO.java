...
public class BoardDAO {
	...
	public int getArticleCount() {
		...
		try {
			...
			if (rs != null)
				try {rs.close();} catch (SQLException sql1) {}
			if (pstmt != null)
				try {pstmt.close();} catch (SQLException sql2) {}
			if (conn != null)
				try {conn.close();} catch (SQLException sql3) {}
		}
			return x;
	}
	...
	public void insertArticle(BoardVO article) {
		...
		try {
			...
			if (pstmt != null)
				try {pstmt.close();} catch (SQLException ex2) {}
			if (conn != null)
