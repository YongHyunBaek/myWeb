...
<%
		...
		customer[0].setEmail("son@son.net");
		customer[0].setPhone("010-1004-1004");
		customer[1] = new Customer();
		customer[1].setName("롱길동");
		customer[1].setEmail("long@long.net");
		customer[1].setPhone("010-5555-5555");
